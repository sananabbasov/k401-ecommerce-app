...
namespace K401Ecommerce.DataAccess.Migrations
{
    ...
    [Migration("20230623172030_Initial24")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("K401Ecommerce.Entities.Concrete.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("K401Ecommerce.Entities.Concrete.Order", b =>
                {
                    ...
                    b.HasOne("K401Ecommerce.Entities.Concrete.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("K401Ecommerce.Entities.Concrete.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
